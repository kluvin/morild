defmodule MorildWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `MorildWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MorildWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MorildWeb.Gettext, "errors", msg, opts)
    end
  end
